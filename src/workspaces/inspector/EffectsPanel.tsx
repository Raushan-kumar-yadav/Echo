...
export default function EffectsPanel() {
  ...
  const handleDragStart = (type: string, e: React.DragEvent) => {
    ...
    e.dataTransfer.setData('application/echo-effect', type)
  ...
  return (
    <div className="efx-panel">
      ...
      <div
        ...
        onDragOver={e => {
          if (e.dataTransfer.types.includes('application/echo-effect')) {
        ...
        onDrop={async e => {
          ...
          const type = e.dataTransfer.getData('application/echo-effect') || dragTypeRef.current
