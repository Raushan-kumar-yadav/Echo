...
function base() { return `http://127.0.0.1:${(window as any).__ECHO_PORT__ ?? 8000}`; }
                  ...
                  return (
                    <div key={i} className="lib__semantic-hit"
                      ...
                      onDragStart={e => {
                        ...
                        e.dataTransfer.setData('application/echo-scene-hit', payload);
                        e.dataTransfer.setData('text/echo-scene-hit', payload); // Electron fallback
                      }}
                      onClick={async () => {
                        if (!asset) return;
              ...
              <div key={wc.assetId} className="lib__card-wrap">
                <LibCard
                  ...
                  onDragStart={e => {
                    ...
                    e.dataTransfer.setData('application/echo-webcomp', JSON.stringify(wc));
                    e.dataTransfer.effectAllowed = 'copy';
                  }}
                ...
                <div key={comp.compId} className="lib__card-wrap">
                  <LibCard
                    ...
                    onDragStart={e => {
                      ...
                      e.dataTransfer.setData('application/echo-comp', JSON.stringify(comp));
                      e.dataTransfer.effectAllowed = 'copy';
                    }}
                    onDragEnd={() => setDragging(null)}
                ...
                <div key={asset.assetId} className="lib__card-wrap">
                  <LibCard
                    ...
                    onDragStart={e => {
                      ...
                      e.dataTransfer.setData('application/echo-asset', JSON.stringify(asset));
                      e.dataTransfer.effectAllowed = 'copy';
                    }}
                    onDragEnd={() => setDragging(null)}
